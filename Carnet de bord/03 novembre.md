1er séance :
résumé : 
- réflexion sur les thèmes
- formation des groupes
- proposition de jeux et vote
- répartition des taches


Projet : concevoir un jeu sérieux

- Jeu sélectionné : Ordinateur Tu utiliseras
   - Apprendre à utiliser Windows / GNU Linux
- format sélectionné : site internet
- cible : Tout niveaux : débutant et niveau avancé
- Objectif : Sous la forme de mission, apprendre à réaliser des tâches sur Windows et Linux (GNU Linux)

  Idée de jeu :
  - Survie agricole : Apprendre a bien choisir les semences et plantes en fonction des conditions de l'environnement
